	...
	return (
        ...
        // </Link>
				...
				<button
					...
					className="h-12 px-2 flex items-center gap-1 text-3xl font-bold text-white hover:text-black focus:text-black hover:bg-white focus:bg-white rounded-full"
				>
					<span className="hidden lg:inline-block text-sm">Sign in</span>
                    <span className="sr-only">Sign in</span>
                    <CiUser />
